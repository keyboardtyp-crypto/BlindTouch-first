...
export default function Home() {
  ...
  useEffect(() => {
    // 💡 ブラウザのコンソールに環境変数を出力してチェック
    const envUrl = process.env.NEXT_PUBLIC_SUPABASE_URL;
    const envKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY;

    console.log("=== Vercel Environment Variables Check ===");
    console.log("NEXT_PUBLIC_SUPABASE_URL:", envUrl ? `OK (${envUrl.slice(0, 15)}...)` : "❌ 読み込めていません (undefined)");
    console.log("NEXT_PUBLIC_SUPABASE_ANON_KEY:", envKey ? `OK (${envKey.slice(0, 10)}...)` : "❌ 読み込めていません (undefined)");
    console.log("==========================================");
